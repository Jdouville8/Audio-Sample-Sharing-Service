						...
						>
							...
							>
								<CardContent>
									...
									>
										Are you interested in receiving technical and industry
										related feedback from your favorite artists in the scene?
									</Typography>
									<br />
									<Typography>
										<b>WavMovers</b> offers 1-on-1 lesson scheduling with
										professional artists to give you the tools you need to
										create. Our artists can cover a vast array of topics
										including: Track arrangement, DAW Workflow, Sound design,
										Mixing, Mastering, DJing, Music theory, Track feedback,
										Industry consulting, and Artistic identity guidance
									</Typography>
									<br />
									<Typography>
									...
									{showItem ? (
										<CheckoutContainer value={handlePaySuccess} />
									) : (
										<div>
											<Button
